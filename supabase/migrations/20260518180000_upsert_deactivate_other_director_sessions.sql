-- Deactivate other live_sessions for the same director before creating/activating a new one.
...
BEGIN
  ...
  -- Only one active session per director: close previous rows first.
