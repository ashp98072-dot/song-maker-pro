...
export default function ListsPage() {
  ...
  return (
    <div className="container px-4 py-6 max-w-6xl">
      ...
      {incomingShared && (
        <div className="glass-card p-4 mb-6 border border-gold/40 bg-gold/5 animate-in fade-in slide-in-from-top-4">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold font-display text-foreground">Mis Listas</h1>
          <p className="text-muted-foreground text-sm">Tus listas se sincronizan automáticamente en la nube</p>
        </div>
