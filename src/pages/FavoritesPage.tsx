...
export default function FavoritesPage() {
  ...
  return (
    <div className="container px-4 py-6 max-w-6xl">
      <div className="mb-6">
        <h1 className="text-2xl font-bold font-display text-foreground">Favoritos</h1>
        <p className="text-muted-foreground text-sm">Tus canciones marcadas como favoritas</p>
      </div>
