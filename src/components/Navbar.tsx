    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-sm app-navbar-safe">
      <div className="container flex items-center justify-between h-14 px-4">
        <Link to="/" className="flex items-center gap-2">
          <img src={logoUrl} alt="Worship Transpose" className="w-9 h-9 rounded-full object-cover ring-1 ring-gold/40" />
          <span className="font-display font-bold text-foreground hidden sm:inline">Worship Transpose</span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setMenuOpen(!menuOpen)}
            ...
            <div className="w-7 h-7 rounded-full bg-secondary flex items-center justify-center text-foreground font-semibold text-xs">
